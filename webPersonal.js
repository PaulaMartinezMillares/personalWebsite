...
// Estamos creando una variable que haga que cuando tenemos clickado (true) contacto, afecte la clase highlight (línea 323 de js)
...
function abrirContacto() {
    ...
    // La clase highlight está en el botón contacto para que afecte el código de la línea 317.
    // Como tenemos la variable true, cuando estamos en la función abrirContacto(), highligh funcionaría.
    menuAbierto = true;
...
function cerrarContacto() {
    ...
    // Como queremos que highlight no funcione cuando cerremos el contacto (cerrarContacto()), marcamos esta variable como false.
    menuAbierto = false;
...
// Afecta a todas las secciones porque ACTIVE es una clase de bootstrap
...
// Opacidad de la galería al hacer hover en el nav lateral
// Todo aquello que tenga la clase highlight pondrá opacidad incicada en .gallery
$('.highlight').mouseover(function () {
    $('.gallery').css('opacity', '0.6');
});
